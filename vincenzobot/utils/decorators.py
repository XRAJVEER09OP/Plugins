...
from vincenzo import LOGS, bot, tbot
from vincenzo.clients import V2, V3, V4, V5
from vincenzo.config import Config
...
def on(**args):
    def decorator(func):
        ...
        if V2:
            V2.add_event_handler(wrapper, events.NewMessage(**args))
        if V3:
            V3.add_event_handler(wrapper, events.NewMessage(**args))
        if V4:
            V4.add_event_handler(wrapper, events.NewMessage(**args))
        if V5:
            V5.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
...
def register(**args):
    ...
    def decorator(func):
        ...
        if V2:
            V2.add_event_handler(func, events.NewMessage(**args))
        if V3:
            V3.add_event_handler(func, events.NewMessage(**args))
        if V4:
            V4.add_event_handler(func, events.NewMessage(**args))
        if V5:
            V5.add_event_handler(func, events.NewMessage(**args))
        try:
